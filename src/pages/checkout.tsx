      ...
      <Box sx={{ marginBottom: "115px", backgroundColor: "#fff" }}>
        ...
        <Box >
          <Box sx={{ display: "flex", margin: "10px", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
            ...
            <Typography variant="body1">{currencyFormat.format(cartTotal)}</Typography>
          </Box>
          <Box sx={{ display: "flex", margin: "10px", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
            <Typography variant="body1">Phí vận chuyển</Typography>
            <Typography variant="body1">{currencyFormat.format(shippingFee)}</Typography>
          </Box>
          <Box sx={{ display: "flex", margin: "10px", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
            <Typography variant="body1">Tổng cộng</Typography>
            <Typography variant="body1">{currencyFormat.format(cartTotal + shippingFee)}</Typography>
          </Box>
        </Box>
        ...
        <Box sx={{
          ...
          <Button variant="contained" onClick={() => handleCheckOut()}>Đặt hàng</Button>
    ...
    return (
      <Box>
        <Box sx={{ alignItems: "center", flexDirection: "column", display: "flex" }}>
          <img style={{ width: "300px" }} src="https://img.icons8.com/?size=512&id=119194&format=png" />
          <Typography variant='h6'>Hổng có gì trong giỏ hết</Typography>
          <Typography variant='subtitle1'>Lướt CoffeeTree, lựa cà phê ngay đi!</Typography>
          <Button variant="outlined" onClick={() => navigate('/')}>Mua sắm ngay</Button>
        </Box>
      </Box>
    )
  }
